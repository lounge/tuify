...
func (m nowPlayingModel) isTrack() bool {
	return strings.HasPrefix(m.trackURI, "spotify:track:")
}

func (m nowPlayingModel) trackID() string {
	if !m.isTrack() {
		return ""
	}
	return strings.TrimPrefix(m.trackURI, "spotify:track:")
}
